...
//    Serial.printf("Acc : %.2f  %.2f  %.2f   ", accX, accY, accZ);
    ...
    if(mode == 0){    
        ...
        while(1){  
          ...
          M5.IMU.getAccelData(&accX, &accY, &accZ);   //加速度取得
          //Serial.printf("Acc : %.2f  %.2f  %.2f  %d \r\n", accX, accY, accZ);
          
          gakufu[0][0] = abs(accX * 100);
          gakufu[0][1] = 0;
          gakufu[0][2] = 0;
          gakufu[0][3] = 0;
          gakufu[0][4] = 0;
          ...
          if(accY > 0){
            gakufu[0][1] = abs(accY * 100);
          }
          else{          
            gakufu[0][2] = abs(accY * 100);
          }

          if(gakufu[0][0] > 85){gakufu[0][0] = 85;}
          if(gakufu[0][0] < 10){gakufu[0][0] = 10;}
          gakufu[0][0] -= 10; 
          gakufu[0][0] *= 2;
          Serial.printf("Acc : %.2f  %.2f  %.2f  [0]= %d  [1]=%d [2]=%d\r\n", accX, accY, accZ, gakufu[0][0],gakufu[0][1],gakufu[0][2]);
          ...
          if(gakufu[0][2] > 20){
            ...
            gakufu[0][3] = gakufu[0][0];
            gakufu[0][4] = gakufu[0][0];
            if(gakufu[0][4] > 20)gakufu[0][4] = gakufu[0][4] - (gakufu[0][2] / 2);

            gakufu[0][2] = gakufu[0][0];
            gakufu[0][1] = gakufu[0][0];
          }
          else{
            gakufu[0][1] = gakufu[0][0];
            gakufu[0][2] = gakufu[0][0];
        ...
        servo_write(1, gakufu[0][0]);
        servo_write(2, 150 - gakufu[0][1]);
        servo_write(3, 150 - gakufu[0][2]);
        servo_write(4, 150 - gakufu[0][3]);
        servo_write(5, 150 - gakufu[0][4]);
